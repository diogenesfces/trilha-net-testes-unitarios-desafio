...
## Desafio de projeto
Para este desafio, usei meus conhecimentos adquiridos no módulo de Testes Unitários com C#, da trilha .NET da DIO.
...
![Métodos Swagger](Imagens/Captura de tela de Tests.png)
